      ...
      <div className="m-0 m-auto flex max-w-screen-2xl gap-4 md:flex-row">
        ...
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-1/5">
          <div className="mt-4 space-y-2">
            {candidates.map((type) => (
              <label htmlFor={type.name} key={type.name} className="text-slate-700 has-[:checked]:ring-indigo-200 grid grid-cols-[1fr_auto] items-center gap-6 rounded-lg p-4 ring-1 ring-transparent hover:bg-slate-100">
              {type.name}
