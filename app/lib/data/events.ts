...
export const events : Events[] = [
  {
    "id": "great-recession",
    "name": "글로벌 금융위기",
    "description": "리먼브라더스 파산을 계기로 촉발된 글로벌 금융 시스템 붕괴와 대침체",
    "date": "2008-09",
    "url": "/series/kospi/base-rate-korea"
  },
  {
    "id": "eurozone-debt-crisis",
    "name": "유럽 재정위기",
    "description": "그리스 국가부채 문제로 확산된 유로존 재정·금융 불안",
    "date": "2010-05",
    "url": "/series/kospi"
  },
  {
    "id": "us-credit-downgrade",
    "name": "미국 신용등급 강등",
    "description": "미국 재정적자 우려로 S&P가 국가신용등급을 강등",
    "date": "2011-08",
  ...
  },
  {
    "id": "taper-tantrum",
    "name": "테이퍼 텐트럼",
    "description": "미 연준의 양적완화 축소 시사로 글로벌 금융시장이 급변동",
    "date": "2013-05",
  ...
  },
  {
    ...
    "name": "미·중 무역전쟁",
    "description": "관세 인상과 보복 조치로 글로벌 교역과 제조업 둔화",
    "date": "2018-03",
    "url": "/series/kospi/current-account-balance-korea"
  },
  {
